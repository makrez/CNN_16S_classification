...
import yaml
from models import *
from training_functions import train_vae_network 
...
for params in grid:
    ...
    model = model_class(input_length=alignment_length)
    ...
    train_losses, valid_losses = train_vae_network(params['n_epoch'], model, optimizer, train_dataloader, valid_dataloader, device, directory, logger, pretrained_model_path=pretrained_model)
